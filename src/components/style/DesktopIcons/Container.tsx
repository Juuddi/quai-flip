...
const DesktopIcons = ({
  ...
  return (
    <div className='desktop-icons-wrapper'>
      <DesktopButton
        icon={<Freecell1 variant='32x32_4' className='desktop-icon-img' />}
        name='QuaiFlip'
      ...
      />
      <DesktopButton
        icon={<Mshearts1 variant='32x32_4' className='desktop-icon-img' />}
        name='Poker Galore'
      ...
      <DesktopButton
        icon={
          <Oislb400DcScanIco variant='32x32_4' className='desktop-icon-img' />
        }
      ...
      />
      <DesktopButton
        icon={<Shell32167 variant='32x32_4' className='desktop-icon-img' />}
        name='Double-X Slots'
