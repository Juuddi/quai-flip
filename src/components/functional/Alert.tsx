...
const Alert = () => {
	return (
		<Frame
			className='alert-outer-frame'
			style={{ width: '450px' }}
		>
			<Frame
				boxShadow='in'
				className='alert-inner-frame'
			>
				<ModalTitle
					title='Error'
					button1='?'
				...
				<div className='alert-content-wrapper'>
					...
					<div className='alert-text-wrapper'>
						This app uses Pelagus to interact with Quai Network. Please install the Pelagus extension and
						enable the it to continue.
					</div>
				</div>
